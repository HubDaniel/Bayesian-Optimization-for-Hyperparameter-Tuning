# -*- coding: utf-8 -*-
"""
Created on Sat Mar 12 15:13:05 2022

@author: reference.  https://github.com/fmfn/BayesianOptimization
"""
...
class BayesianOptimization(Observable):
    ...
    def __init__(self, f, pbounds, random_state=None, verbose=2,
        ...
        self._gp = GaussianProcessRegressor(
            kernel=Matern(nu=2.5), # [0.5, 1.5, "2.5", "inf"]
            alpha=1e-6,
            normalize_y=True,
    ...
    def probe(self, params, lazy=True):
        ...
        if lazy:
            ...
            self._targets.append(self._space.probe(params))
